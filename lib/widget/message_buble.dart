import 'package:chat_bot/widget/alert_dilog.dart';
...
class _MessageBubbleState extends State<MessageBubble> {
  Future _deleteData(String mess, String refId) async {
    final cuUser = FirebaseAuth.instance.currentUser;
    print("Message $mess");
    try {
      await FirebaseFirestore.instance.collection("Chat").doc(refId).delete();
      // ignore: use_build_context_synchronously
      ScaffoldMessenger.of(context).clearSnackBars();
      // ignore: use_build_context_synchronously
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text("$mess Message deleted"),
        ),
      );
    } catch (e) {
                                ...
                                actions: [
                                  TextButton(
                                    onPressed: () {
                                      setState(() {
                                        _deleteData(
                                            widget.message, widget.refrencId);
